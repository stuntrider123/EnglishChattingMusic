...
@Client.on_message(command(["play", "dz$play"]))
...
#        return await app.leave_chat(chat_id)  
    ...
    if audio:
        ...
        mystic = await message.reply_text(f"🔄 processing audio...")
        ...
        if len(message.command) < 2:
            ...
            thumb ="https://telegra.ph/file/11100db05aaad2a2aef9b.jpg"
        ...
        thumb ="cache/PicsArt_11-28-04.13.03.jpg"
...
async def startyuplay(_,CallbackQuery): 
    ...
    if await is_active_chat(chat_id):
        ...
        photo=thumb,
        caption=(f"〃<b>**Queue added to:**</b> <b>#{position}! \n\n〃<b>**Name:** </b>[{title[:25]}]({url}) \n〃<b>**Duration:**</b> {duration} \n〃<b>**Request by:** </b>{checking}"),
        reply_markup=InlineKeyboardMarkup(buttons)
    )
        os.remove(thumb)
        await CallbackQuery.message.delete()       
