...
async def gen_thumb(thumbnail, title, userid, theme, ctitle):
    ...
    draw.text((120, 595), f"{title[:30]}...", fill= "black", stroke_width = 1, stroke_fill="black", font=font2)
    draw.text((17, 45), f"Playing on: {ctitle[:20]}...", fill="black", stroke_width = 1, stroke_fill="black" ,font=font)
